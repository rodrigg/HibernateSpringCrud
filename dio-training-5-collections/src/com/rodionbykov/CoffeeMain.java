...
public class CoffeeMain {
    ...
    public static void main(String[] args) {
        ...
        HashSet<CoffeeCup> coffeeCupsSet1 = new HashSet<CoffeeCup>(Arrays.asList(coffeeCups1));
        HashSet<CoffeeCup> coffeeCupsSet2 = new HashSet<CoffeeCup>(Arrays.asList(coffeeCups2));

        CoffeeMachine coffeeMachine = new CoffeeMachine();
        ServiceDelegate serviceDelegate = new ServiceDelegate(coffeeMachine);

        HashSet<CoffeeCup> coffeeCups3 = serviceDelegate.mergeSets(coffeeCupsSet1, coffeeCupsSet2);

        System.out.println(coffeeCups3.toString());
